...
| `companies search` | `op companies search` | `GET` | `/api/external/v1/companies/search` |
...
| `documents list_drafts` | `op documents list_drafts` | `GET` | `/api/external/v1/documents/list_drafts` |
...
| `goals count_children` | `op goals count_children` | `GET` | `/api/external/v1/goals/count_children` |
...
| `project_templates update_document` | `op project_templates update_document` | `POST` | `/api/external/v1/project_templates/update_document` |
| `project_templates update_file` | `op project_templates update_file` | `POST` | `/api/external/v1/project_templates/update_file` |
