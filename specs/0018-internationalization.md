...
### Company and space administration follow-up — complete

Audited company admin home, add/manage/restore people, admins and owners, permissions, rename, trusted email domains, billing (including plan selection and cancellation), export/import, and their app-wrapper messages. Audited space creation/editing, general access, access management, member addition, and tool configuration.
...
Navigation chrome/shared defaults and account/onboarding belong to their separate extraction slices; operator SaaS administration is outside this administration slice. User-authored content and machine identifiers are not translated.
