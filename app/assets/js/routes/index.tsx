  ...
  return createRouter([
    {
      ...
      children: [
        ...
        pageRoute("/company-import", pages.CompanyImportPage, { preload: false }),
        pageRoute("/billing/pick-company", pages.BillingPickCompanyPage, { preload: false }),
        pageRoute("/new", pages.NewCompanyPage),
        pageRoute("/setup", pages.SetupPage, { auth: false, preload: false }),
        pageRoute("/join", pages.JoinPage, { auth: false, preload: false }),
        pageRoute("/join/:token", pages.InviteLinkJoinPage, { auth: false, preload: false }),
        pageRoute("/join/:token/full", pages.InviteLinkFullPage, { auth: false, preload: false }),
      ],
    },
    saasAdminRoutes(),
    {
      ...
      children: [
        ...
        pageRoute("admin/billing", pages.CompanyBillingPage, { preload: false }),
        pageRoute("admin/billing/plans", pages.CompanyBillingPlanSelectionPage, { preload: false }),
        pageRoute("admin/billing/cancel", pages.CompanyBillingCancellationPage, { preload: false }),
        ...
        pageRoute("project-templates", pages.ProjectTemplatesPage),
        pageRoute("project-templates/:templateId/discussions/new", pages.ProjectTemplateDiscussionNewPage),
        pageRoute("project-templates/:templateId/discussions/:id/edit", pages.ProjectTemplateDiscussionEditPage),
        pageRoute("project-templates/:templateId/discussions/:id", pages.ProjectTemplateDiscussionPage),
        pageRoute("project-templates/:templateId/documents/new", pages.ProjectTemplateNewDocumentPage),
        ...
        pageRoute("project-templates/:templateId/links/:id", pages.ProjectTemplateLinkPage),
        pageRoute("project-templates/:templateId/files/:id/edit", pages.ProjectTemplateEditFilePage),
        pageRoute("project-templates/:templateId/files/:id", pages.ProjectTemplateFilePage),
        pageRoute("project-templates/:templateId/milestones/:id", pages.ProjectTemplateMilestonePage),
        ...
        pageRoute("goals/:goalId/access", pages.GoalAccessManagementPage),
        pageRoute("goals/:goalId/access/add", pages.GoalAccessAddPage),
        pageRoute("goals/:goalId/edit/permissions", pages.GoalEditAccessLevelsPage),
