  ...
  return createRouter([
    ...
    saasAdminRoutes(),
    {
      ...
      children: [
        ...
        pageRoute("project-templates/:templateId/docs-and-files/new", pages.ProjectTemplateNewDocumentPage),
        pageRoute("project-templates/:templateId/docs-and-files/:nodeId", pages.ProjectTemplateResourcePage),
