  ...
  return (
    <Pages.Page title="New Goal" testId="goal-add-page">
      <Paper.Root size="large">
        <Paper.NavigateBack to={DeprecatedPaths.workMapPath()} title={`Back to ${space!.name} Space`} />
...
function NewGoalPage({ form }: { form: FormState }) {
  ...
  return (
    <Pages.Page title="New Goal" testId="goal-add-page">
      <Paper.Root size="large">
        <Paper.NavigateBack to={DeprecatedPaths.workMapPath()} title="Back to Work Map" />
