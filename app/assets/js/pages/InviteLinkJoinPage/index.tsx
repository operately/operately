...
async function loader({ params }): Promise<LoaderResult> {
  ...
  try {
    const result = await InviteLinks.getInviteLink({ token });
...
function Page() {
  ...
  const [joinCompany, { loading: joining }] = InviteLinks.useJoinCompanyViaInviteLink();
        ...
        <Paper.Root size="small">
          ...
          <Paper.Body>
            <div className="text-center">
              ...
              <div className="text-content-accent text-2xl font-extrabold mt-6 mb-4">
                Invalid Invite Link
              </div>
