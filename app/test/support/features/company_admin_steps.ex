defmodule Operately.Support.Features.CompanyAdminSteps do
  ...
  import Operately.BlobsFixtures, only: [blob_fixture: 1]
  ...
  step :setup, ctx, as: role do
    ctx
    |> given_a_company_exists()
    |> given_i_am_logged_in(as: role)
  end
  ...
  step :fill_company_to_one_below_member_limit, ctx do
  ...
  step :fill_company_to_near_storage_limit, ctx do
  ...
  step :assert_no_person_added, ctx, email do
  ...
  step :assert_member_still_suspended, ctx, key do
