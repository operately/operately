defmodule Operately.Features.GoalTest do
  ...
  describe "permissions" do
    ...
    feature "user with edit access can see edit and check-in buttons but not delete", ctx do
      ctx
    ...
    feature "user with comment access can only see discussion button", ctx do
      ctx
