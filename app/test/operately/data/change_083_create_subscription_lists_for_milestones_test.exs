defmodule Operately.Data.Change083CreateSubscriptionListsForMilestonesTest do
  ...
  defp drop_constraint do
    Repo.query!("ALTER TABLE project_milestones ALTER COLUMN subscription_list_id DROP NOT NULL")
  end

  defp restore_constraint do
    Repo.query!("ALTER TABLE project_milestones ALTER COLUMN subscription_list_id SET NOT NULL")
  end
end
