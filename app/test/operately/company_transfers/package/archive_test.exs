defmodule Operately.CompanyTransfers.Package.ArchiveTest do
  ...
  test "extract_present!/3 accepts a ZIP that contains a subset of the declared file entries" do
    ...
    extracted = Archive.extract_present!(zip_path, extract_dir, ["present.txt", "missing.txt"])
