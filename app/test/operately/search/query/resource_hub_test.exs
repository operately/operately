defmodule Operately.Search.Query.ResourceHubTest do
  ...
  defp sync(type, id) do
    source_type = Search.Indexing.ResourceHub.source_type(type)
    assert {:ok, _summary} = Synchronizer.sync(source_type, id)
  end
end
