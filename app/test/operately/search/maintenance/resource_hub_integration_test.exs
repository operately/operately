defmodule Operately.Search.Maintenance.ResourceHubIntegrationTest do
  ...
  alias Operately.Search.{Entry, Indexing}
  alias Operately.Search.Maintenance.Run
  ...
  defp start_and_drain_all(kind) do
    Oban.Testing.with_testing_mode(:manual, fn ->
      ...
      Enum.map(runs, &Repo.get!(Run, &1.id))
    end)
  end
