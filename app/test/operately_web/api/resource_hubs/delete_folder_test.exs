defmodule OperatelyWeb.Api.ResourceHubs.DeleteFolderTest do
  ...
  describe "security" do
    test "it requires authentication", ctx do
      assert {401, _} = mutation(ctx.conn, [:resource_hubs, :delete_folder], %{})
    end
  end
  ...
  describe "functionality" do
    ...
    test "deletes folder", ctx do
      assert {200, res} = mutation(ctx.conn, [:resource_hubs, :delete_folder], %{
