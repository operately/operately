defmodule OperatelyWeb.Api.Goals.CloseTest do
  ...
  describe "security" do
    test "it requires authentication", ctx do
      assert {401, _} = mutation(ctx.conn, [:goals, :close], %{})
    end
  end
  ...
  describe "subscriptions to notifications" do
    ...
    test "creates subscription list for goal closing", ctx do
      assert {200, _} = mutation(ctx.conn, [:goals, :close], %{
