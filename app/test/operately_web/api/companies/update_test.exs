defmodule OperatelyWeb.Api.Companies.UpdateTest do
  use OperatelyWeb.TurboCase

  describe "security" do
    test "it requires authentication", ctx do
      assert {401, _} = mutation(ctx.conn, [:companies, :update], %{})
    end
  end
  ...
  describe "authorization" do
    ...
    test "company admin can edit", ctx do
      ...
      assert {200, _} = mutation(ctx.conn, [:companies, :update], %{name: "Hello"})
    end
