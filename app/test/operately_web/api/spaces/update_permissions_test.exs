defmodule OperatelyWeb.Api.Spaces.UpdatePermissionsTest do
  ...
  describe "security" do
    test "it requires authentication", ctx do
      assert {401, _} = mutation(ctx.conn, [:spaces, :update_permissions], %{})
    end
  end
  ...
  defp request(conn, space) do
    mutation(conn, [:spaces, :update_permissions], %{
