defmodule OperatelyWeb.Api.Spaces.EditMembersPermissionsTest do
  ...
  describe "security" do
    test "it requires authentication", ctx do
      assert {401, _} = mutation(ctx.conn, [:spaces, :edit_members_permissions], %{})
    end
  end
  ...
  defp request(conn, space, people) do
    mutation(conn, [:spaces, :edit_members_permissions], %{
