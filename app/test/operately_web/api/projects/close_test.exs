defmodule OperatelyWeb.Api.Projects.CloseTest do
  ...
  describe "security" do
    test "it requires authentication", ctx do
      assert {401, _} = mutation(ctx.conn, [:projects, :close], %{})
    end
  end
  ...
  describe "subscriptions to notifications" do
    ...
    test "creates subscription list for project retrospective", ctx do
      ...
      assert {200, res} = mutation(ctx.conn, [:projects, :close], %{
