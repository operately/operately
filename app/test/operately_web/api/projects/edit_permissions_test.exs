defmodule OperatelyWeb.Api.Projects.EditPermissionsTest do
  ...
  describe "security" do
    test "it requires authentication", ctx do
      assert {401, _} = mutation(ctx.conn, [:projects, :edit_permissions], %{})
    end
  end
  ...
  defp request(conn, project) do
    mutation(conn, [:projects, :edit_permissions], %{
