defmodule OperatelyWeb.Api.Projects.UpdatePermissionsTest do
  ...
  describe "security" do
    test "it requires authentication", ctx do
      assert {401, _} = mutation(ctx.conn, [:projects, :update_permissions], %{})
    end
  end
  ...
  defp request(conn, project) do
    mutation(conn, [:projects, :update_permissions], %{
  ...
  defp create_contributor(ctx, project, permissions) do
    ...
    {:ok, _} =
      Projects.create_contributor(ctx.person, %{
