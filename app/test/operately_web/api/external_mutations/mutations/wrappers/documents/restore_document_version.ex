defmodule OperatelyWeb.Api.ExternalMutations.Mutations.Wrappers.Documents.RestoreDocumentVersion do
  ...
  @impl true
  def mutation_name, do: "documents/restore_document_version"
