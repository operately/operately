defmodule OperatelyWeb.Api.ExternalMutations.Mutations.Projects.UpdateMilestoneDescription do
  use Operately.Support.ExternalApi.MutationSpec
  use OperatelyWeb.TurboCase

  @impl true
  def mutation_name, do: "projects/update_milestone_description"
