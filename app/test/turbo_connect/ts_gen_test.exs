defmodule TurboConnect.TsGenTest do
  ...
  test "generating TypeScript shared types only" do
    ...
    refute result =~ "import React"
    refute result =~ "import axios"
    refute result =~ "useQuery"
    refute result =~ "useMutation"
    refute result =~ "ApiClient"
    refute result =~ "GetUserInput"
    refute result =~ "GetUserResult"
    refute result =~ "UsersGetUserInput"
    refute result =~ "UsersCreateUserResult"
  end
