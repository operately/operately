defimpl OperatelyWeb.Api.Serializable, for: Operately.Goals.Retrospective do
  def serialize(retro, level: :essential) do
    %{
      ...
      acknowledged_at: OperatelyWeb.Api.Serializer.serialize(retro.acknowledged_at),
      acknowledged_by: OperatelyWeb.Api.Serializer.serialize(retro.acknowledged_by, level: :essential),
    }
  end
end
