  ...
  defmacro common_endpoints do
    quote do
      ...
      namespace(:projects) do
        ...
        mutation(:edit_name, OperatelyWeb.Api.Projects.EditName)
        mutation(:edit_permissions, OperatelyWeb.Api.Projects.EditPermissions)
        mutation(:edit_retrospective, OperatelyWeb.Api.Projects.EditRetrospective)
      ...
      namespace(:spaces) do
        ...
        mutation(:edit, OperatelyWeb.Api.Spaces.Edit)
        mutation(:edit_members_permissions, OperatelyWeb.Api.Spaces.EditMembersPermissions)
        mutation(:edit_permissions, OperatelyWeb.Api.Spaces.EditPermissions)
