defmodule Operately.Data.Change066UpdateTimeframeInGoalActivities.GoalCreated do
  import Ecto.Query
  alias Operately.Repo
  alias Operately.Activities.Activity

  def run do
    goal_created_activities = Repo.all(
      from a in Activity,
      where: a.action == "goal_created",
      select: a
    )

    {success_count, error_count} = Enum.reduce(goal_created_activities, {0, 0}, fn activity, {success, error} ->
