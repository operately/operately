defmodule Operately.People.EmailChange do
  ...
  alias Operately.People.EmailChange.{Cancel, Confirm, Request, Shared}
  alias Operately.Repo

  @outcomes [:success, :invalid_email, :email_unchanged, :email_taken, :rate_limited, :delivery_unavailable, :delivery_failed, :request_invalid, :code_expired, :invalid_code, :too_many_attempts]
  ...
  def state(account) do
    ...
    pending = Repo.one(from r in Shared.pending_query(account), where: r.original_email == ^account.email)
