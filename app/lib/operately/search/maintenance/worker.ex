defmodule Operately.Search.Maintenance.Worker do
  use Oban.Worker,
    queue: :default,
    max_attempts: 5,
  ...
  alias Operately.Search.Maintenance.{BatchRunner, ErrorCategory}

  @impl Oban.Worker
  def perform(%Oban.Job{args: args, attempt: attempt, max_attempts: max_attempts}) do
    case BatchRunner.run_batch(args) do
      {:ok, _result} ->
        :ok
      ...
      {:error, reason} when attempt >= max_attempts ->
        ...
        case BatchRunner.mark_failed(args, reason) do
          :ok ->
