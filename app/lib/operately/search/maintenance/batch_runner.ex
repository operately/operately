defmodule Operately.Search.Maintenance.BatchRunner do
  @moduledoc """
  ...
  alias Operately.Search.Maintenance.{BatchProcessor, RunLifecycle}
  ...
  defp process_batch(run, batch_size) do
    ...
    with {:ok, source_module} <- AdapterRegistry.fetch(source_type),
