defmodule Operately.Search.Indexing.AdapterRegistry do
  @moduledoc """
  ...
  duplicate types or modules that do not implement the `Operately.Search.Indexing.Adapter`
  ...
  Returns registered adapters keyed by their stable source type.
      ...
      {:ok, %{
        "resource_hub_document" => Operately.Search.Indexing.Adapters.ResourceHub.Document
      }}
