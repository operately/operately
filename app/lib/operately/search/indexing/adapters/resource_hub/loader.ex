defmodule Operately.Search.Indexing.Adapters.ResourceHub.Loader do
  @moduledoc false
  ...
  alias Operately.Search.Indexing.Adapters.ResourceHub.{AncestorVisibility, Metadata, Record}
