defmodule Operately.Access.Binding do
  ...
  @view_access 10
  @comment_access 40
  @contribute_access 55
  @edit_access 70
  @full_access 100

  @valid_access_levels [@no_access, @view_access, @comment_access, @contribute_access, @edit_access, @full_access]
  ...
  def contribute_access, do: @contribute_access
  ...
  def from_atom(:contribute_access), do: @contribute_access
