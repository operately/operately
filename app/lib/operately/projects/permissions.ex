defmodule Operately.Projects.Permissions do
  ...
  def calculate(access_level) when is_integer(access_level) do
    %__MODULE__{
      ...
      can_edit_timeline: access_level >= Binding.full_access(),
      ...
      can_close: access_level >= Binding.full_access(),
      can_pause: access_level >= Binding.full_access(),
      can_resume: access_level >= Binding.full_access(),
