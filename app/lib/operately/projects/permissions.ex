defmodule Operately.Projects.Permissions do
  ...
  def calculate(access_level) when is_integer(access_level) do
    %__MODULE__{
      ...
      can_complete_milestone: access_level >= Binding.contribute_access(),
      can_reopen_milestone: access_level >= Binding.contribute_access(),
      can_create_milestone: access_level >= Binding.contribute_access(),
      can_create_task: access_level >= Binding.contribute_access(),
      can_edit_milestone: access_level >= Binding.contribute_access(),
      can_delete_milestone: access_level >= Binding.contribute_access(),
      can_edit_check_in: access_level >= Binding.contribute_access(),
      can_edit_description: access_level >= Binding.edit_access(),
      can_edit_timeline: access_level >= Binding.edit_access(),
      can_edit_resources: access_level >= Binding.contribute_access(),
      ...
      can_check_in: access_level >= Binding.contribute_access(),
      can_edit_task: access_level >= Binding.contribute_access(),
      can_edit_statuses: access_level >= Binding.contribute_access(),
      can_acknowledge_check_in: access_level >= Binding.contribute_access(),
