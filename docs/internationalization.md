...
| Task | New task, inline creator (placeholder, Add, Cancel, Add task accessible name), creation modal labels, task name validation, Mark task as done, task creation and rename failure toasts (including titles) |
