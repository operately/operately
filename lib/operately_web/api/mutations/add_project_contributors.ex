defmodule OperatelyWeb.Api.Mutations.AddProjectContributors do
  ...
  inputs do
    ...
    field :contributors, list_of(:project_contributor_input)
  end
  ...
  def call(conn, inputs) do
    ...
    |> run(:check_permissions, fn ctx -> Permissions.check(ctx.project.requester_access_level, :can_edit_contributors) end)
