...
defimpl OperatelyWeb.Api.Serializable, for: Operately.Companies.Company do
  ...
  def serialize(company, level: :full) do
    %{
      ...
      trusted_email_domains: OperatelyWeb.Api.Serializer.serialize(company.trusted_email_domains),
      enabled_experimental_features: OperatelyWeb.Api.Serializer.serialize(company.enabled_experimental_features),
