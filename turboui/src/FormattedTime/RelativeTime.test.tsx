...
describe("RelativeTime", () => {
  ...
  describe("Seconds", () => {
    it("renders 'just now' for < 10 seconds", () => {
      render(<RelativeTime locale="en-US" time={createDate(5 * 1000)} />);
      expect(screen.getByText("just now")).toBeInTheDocument();
    });

    it("renders 'just now' for 9 seconds", () => {
      render(<RelativeTime locale="en-US" time={createDate(9 * 1000)} />);
      expect(screen.getByText("just now")).toBeInTheDocument();
    });

    it("renders 'seconds ago' for 10 to 59 seconds", () => {
      render(<RelativeTime locale="en-US" time={createDate(10 * 1000)} />);
      expect(screen.getByText("10 seconds ago")).toBeInTheDocument();

      render(<RelativeTime locale="en-US" time={createDate(59 * 1000)} />);
  ...
  describe("Minutes", () => {
    describe("On Large Screens", () => {
      ...
      it("renders '1 minute ago' for singular minute", () => {
        render(<RelativeTime locale="en-US" time={createDate(60 * 1000)} />);
        expect(screen.getByText("1 minute ago")).toBeInTheDocument();
      });

      it("renders 'X minutes ago' for plural minutes", () => {
        render(<RelativeTime locale="en-US" time={createDate(5 * 60 * 1000)} />);
        expect(screen.getByText("5 minutes ago")).toBeInTheDocument();

        render(<RelativeTime locale="en-US" time={createDate(59 * 60 * 1000)} />);
    ...
    describe("On Small Screens", () => {
      ...
      it("renders 'min. ago' for minutes on English locales", () => {
        render(<RelativeTime locale="en-US" time={createDate(5 * 60 * 1000)} />);
        expect(screen.getByText("5 min. ago")).toBeInTheDocument();
      });

      it("uses full i18n label for non-English locales", () => {
        render(<RelativeTime locale="fr-FR" time={createDate(5 * 60 * 1000)} />);
        expect(screen.getByText("5 minutes ago")).toBeInTheDocument();
  ...
  describe("Hours", () => {
    it("renders '1 hour ago'", () => {
      render(<RelativeTime locale="en-US" time={createDate(60 * 60 * 1000)} />);
      expect(screen.getByText("1 hour ago")).toBeInTheDocument();
    });

    it("renders 'X hours ago'", () => {
      render(<RelativeTime locale="en-US" time={createDate(5 * 60 * 60 * 1000)} />);
      expect(screen.getByText("5 hours ago")).toBeInTheDocument();

      render(<RelativeTime locale="en-US" time={createDate(23 * 60 * 60 * 1000)} />);
  ...
  describe("Days", () => {
    it("renders '1 day ago'", () => {
      render(<RelativeTime locale="en-US" time={createDate(24 * 60 * 60 * 1000)} />);
      expect(screen.getByText("1 day ago")).toBeInTheDocument();
    });

    it("renders 'X days ago' for < 7 days", () => {
      render(<RelativeTime locale="en-US" time={createDate(6 * 24 * 60 * 60 * 1000)} />);
  ...
  describe("Weeks", () => {
    it("renders '1 week ago'", () => {
      render(<RelativeTime locale="en-US" time={createDate(7 * 24 * 60 * 60 * 1000)} />);
      expect(screen.getByText("1 week ago")).toBeInTheDocument();
    });

    it("renders 'X weeks ago' for standard weeks", () => {
      render(<RelativeTime locale="en-US" time={createDate(3 * 7 * 24 * 60 * 60 * 1000)} />);
      expect(screen.getByText("3 weeks ago")).toBeInTheDocument();
    });

    it("renders '4 weeks ago' for exactly 4 weeks (28 days)", () => {
      // 28 days
      render(<RelativeTime locale="en-US" time={createDate(28 * 24 * 60 * 60 * 1000)} />);
    ...
    it("renders '4 weeks ago' for 29 days (The Logic Gap Fix)", () => {
      ...
      render(<RelativeTime locale="en-US" time={createDate(29 * 24 * 60 * 60 * 1000)} />);
      expect(screen.getByText("4 weeks ago")).toBeInTheDocument();
    });
  });
  ...
  describe("Months", () => {
    it("renders '1 month ago' for exactly 30 days", () => {
      render(<RelativeTime locale="en-US" time={createDate(30 * 24 * 60 * 60 * 1000)} />);
      expect(screen.getByText("1 month ago")).toBeInTheDocument();
    });

    it("renders 'X months ago'", () => {
      render(<RelativeTime locale="en-US" time={createDate(65 * 24 * 60 * 60 * 1000)} />);
      expect(screen.getByText("2 months ago")).toBeInTheDocument();
    });

    it("renders '11 months ago' correctly", () => {
      // 11 months * 30 = 330 days
      render(<RelativeTime locale="en-US" time={createDate(330 * 24 * 60 * 60 * 1000)} />);
  ...
  describe("Years", () => {
    it("renders '1 year ago' for exactly 365 days", () => {
      render(<RelativeTime locale="en-US" time={createDate(365 * 24 * 60 * 60 * 1000)} />);
