...
export function Discussions(props: GoalPage.State) {
  if (props.discussions.length === 0 && !props.canAddDiscussion && props.state !== "closed") return null;

  const showNewDiscussionButton = props.canAddDiscussion && props.state !== "closed";
