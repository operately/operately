...
import FlexibleDatePicker from "./index";

/**
 * FlexibleDatePicker is a component that allows users to select dates in various formats:
 * specific date, month, quarter, semester, or year.
 */
const meta = {
  title: "Components/DatePicker",
  component: FlexibleDatePicker,
  parameters: {
    layout: "centered",
  },
  argTypes: {
...
} satisfies Meta<typeof FlexibleDatePicker>;
