...
export function AssignmentsList({ assignments }: { assignments: ReviewPageV2.Assignment[] }) {
  return (
  ...
  return (
    <DivLink to={assignment.path} className={className} testId={testId}>
      ...
      <div className="flex gap-4 items-center">
        <AssignmentIcon type={assignment.type as ReviewPageV2.AssignmentType} />
...
function AssignmentIcon({ type }: { type: ReviewPageV2.AssignmentType }) {
  return match(type)
...
function AssignmentInfo({ assignment }: { assignment: ReviewPageV2.Assignment }) {
  return match(assignment.type as ReviewPageV2.AssignmentType)
...
function DueProjectCheckIn({ assignment }: { assignment: ReviewPageV2.Assignment }) {
  return (
    <div>
...
function AcknowledgeProjectCheckIn({ assignment }: { assignment: ReviewPageV2.Assignment }) {
  return (
    <div>
      <div>
...
function DueGoalUpdate({ assignment }: { assignment: ReviewPageV2.Assignment }) {
  return (
    <div>
...
function AcknowledgeGoalUpdate({ assignment }: { assignment: ReviewPageV2.Assignment }) {
  return (
    <div>
      <div>
        <span className="font-bold">Review:</span> {assignment.name}
