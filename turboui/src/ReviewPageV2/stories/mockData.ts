...
export const mockMyWorkAssignments: ReviewPageV2.Assignment[] = [
  {
    resourceId: "goal-1",
...
export const mockForReviewAssignments: ReviewPageV2.Assignment[] = [
  {
...
export const mockSingleMyWorkAssignment: ReviewPageV2.Assignment[] = [
  {
...
export const mockSingleForReviewAssignment: ReviewPageV2.Assignment[] = [
  {
...
export const mockOverdueAssignments: ReviewPageV2.Assignment[] = [
  {
