...
// import {
//   DragAndDropProvider,
//   useDraggingAnimation,
//   useDropZone,
// } from "@/features/DragAndDrop";
...
export function GoalTargetList(props: Props) {
  return (
...
function DragAndDropWrapper({ children }) {
  ...
  return (
    <DragAndDropProvider onDrop={reorderTargets}>
      {children}
    </DragAndDropProvider>
  );
}
