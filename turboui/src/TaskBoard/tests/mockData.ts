...
export function mockTasks(type: "space" | "project"): Types.Task[] {
  return [
    ...
    },
    {
      ...
      status: IN_PROGRESS_STATUS,
      description: "Shows how a long task title wraps and still keeps the footer readable",
      link: "#",
      assignees: [mockPeople.jane!],
      milestone: mockMilestones.q2Release!,
      dueDate: null,
    ...
    },
    {
      ...
      status: PENDING_STATUS,
      description: "Another long title to test how multiple wrapped cards feel in the same column",
      link: "#",
      assignees: [mockPeople.emily!],
      milestone: mockMilestones.q2Release!,
      dueDate: null,
    ...
    },
    {
      ...
      status: IN_PROGRESS_STATUS,
      description: "Long title with comments so we can see indicator placement in narrow columns",
      link: "#",
      assignees: [mockPeople.john!],
      milestone: mockMilestones.productLaunch!,
      dueDate: null,
    ...
    },
    {
      ...
      status: PENDING_STATUS,
      description: "Uses a different status so it lands in another column while still wrapping",
      link: "#",
      assignees: [mockPeople.bob!],
      milestone: mockMilestones.productLaunch!,
      dueDate: null,
    ...
    },
    {
      ...
      status: PENDING_STATUS,
      description: "Extra long title to preview wrapping near the scroll edges",
      link: "#",
      assignees: [mockPeople.jane!],
      milestone: mockMilestones.q2Release!,
      dueDate: null,
    ...
    },
    {
      ...
      status: IN_PROGRESS_STATUS,
      description: "Another long task to make sure horizontal scrolling plus wrapping behaves nicely",
      link: "#",
      assignees: [mockPeople.emily!],
      milestone: mockMilestones.q2Release!,
      dueDate: null,
