...
export interface MilestoneCardProps {
  ...
  /**
   * Called when a new task creation is requested for this milestone
   */
  onTaskCreate?: () => void;
 ...
 */
export function MilestoneCard({ milestone, tasks, onTaskCreate, stats }: MilestoneCardProps) {
