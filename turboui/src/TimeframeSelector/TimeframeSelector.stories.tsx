...
import { TimeframeSelector, TimeframeSelectorNamespace } from './index';
...
const TimeframeSelectorWrapper = (args: any) => {
  const [timeframe, setTimeframe] = useState<TimeframeSelectorNamespace.Timeframe>(currentMonth());
...
export const TimeframeTypes: StoryObj = {
  render: () => {
    ...
    const [customTimeframe, setCustomTimeframe] = useState<TimeframeSelectorNamespace.Timeframe>({
      type: 'days',
