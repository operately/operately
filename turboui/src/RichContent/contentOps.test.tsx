...
describe("shortenContent", () => {
  it("few words in a single line", () => {
    ...
    expect(shortenContent(input, 15)).toEqual(JSON.parse(expected));
  });
  ...
  it("few words in several single lines", () => {
    ...
    expect(shortenContent(input, 20, { suffix: "..." })).toEqual(JSON.parse(expected));
  });
  ...
  it("long text in a single line", () => {
    ...
    expect(shortenContent(input, 50)).toEqual(JSON.parse(expected));
  });
  ...
  it("long text in several single lines", () => {
    ...
    expect(shortenContent(input, 75, { suffix: "..." })).toEqual(JSON.parse(expected));
  });
  ...
  it("text that mentions person", () => {
    ...
    expect(shortenContent(input, 40, { suffix: "..." })).toEqual(JSON.parse(expected));
  });
  ...
  it("person name isn't truncated", () => {
    ...
    expect(shortenContent(input, 28, { suffix: "..." })).toEqual(JSON.parse(expected));
  });
});
