...
export class ApiClient {
  ...
  async getActivities(input: GetActivitiesInput): Promise<GetActivitiesResult> {
    return axios
      .get(this.getBasePath() + "/get_activities", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }

  async getActivity(input: GetActivityInput): Promise<GetActivityResult> {
    return axios
      .get(this.getBasePath() + "/get_activity", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }

  async getComments(input: GetCommentsInput): Promise<GetCommentsResult> {
    return axios
      .get(this.getBasePath() + "/get_comments", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }
  ...
  async getDiscussion(input: GetDiscussionInput): Promise<GetDiscussionResult> {
    return axios
      .get(this.getBasePath() + "/get_discussion", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }

  async getDiscussions(input: GetDiscussionsInput): Promise<GetDiscussionsResult> {
    return axios
      .get(this.getBasePath() + "/get_discussions", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }
  ...
  async getGoalCheckIn(input: GetGoalCheckInInput): Promise<GetGoalCheckInResult> {
    return axios
      .get(this.getBasePath() + "/get_goal_check_in", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }

  async getGoalCheckIns(input: GetGoalCheckInsInput): Promise<GetGoalCheckInsResult> {
    return axios
      .get(this.getBasePath() + "/get_goal_check_ins", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }
  ...
  async getInvitation(input: GetInvitationInput): Promise<GetInvitationResult> {
    return axios
      .get(this.getBasePath() + "/get_invitation", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }

  async getKeyResources(input: GetKeyResourcesInput): Promise<GetKeyResourcesResult> {
    return axios
      .get(this.getBasePath() + "/get_key_resources", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }
  ...
  async getMilestone(input: GetMilestoneInput): Promise<GetMilestoneResult> {
    return axios
      .get(this.getBasePath() + "/get_milestone", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }

  async getNotifications(input: GetNotificationsInput): Promise<GetNotificationsResult> {
    return axios
      .get(this.getBasePath() + "/get_notifications", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }
  ...
  async getProjectCheckIn(input: GetProjectCheckInInput): Promise<GetProjectCheckInResult> {
    return axios
      .get(this.getBasePath() + "/get_project_check_in", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }

  async getProjects(input: GetProjectsInput): Promise<GetProjectsResult> {
    return axios
      .get(this.getBasePath() + "/get_projects", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }
  ...
  async getUnreadNotificationCount(input: GetUnreadNotificationCountInput): Promise<GetUnreadNotificationCountResult> {
    return axios
      .get(this.getBasePath() + "/get_unread_notification_count", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }

  async searchPeople(input: SearchPeopleInput): Promise<SearchPeopleResult> {
    return axios
      .get(this.getBasePath() + "/search_people", { params: toSnake(input) })
      .then(({ data }) => toCamel(data));
  }
  ...
  async addCompanyTrustedEmailDomain(
    ...
    return axios
      .post(this.getBasePath() + "/add_company_trusted_email_domain", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async addProjectContributor(input: AddProjectContributorInput): Promise<AddProjectContributorResult> {
    return axios
      .post(this.getBasePath() + "/add_project_contributor", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async changePasswordFirstTime(input: ChangePasswordFirstTimeInput): Promise<ChangePasswordFirstTimeResult> {
    return axios
      .post(this.getBasePath() + "/change_password_first_time", toSnake(input))
      .then(({ data }) => toCamel(data));
  }

  async changeTaskDescription(input: ChangeTaskDescriptionInput): Promise<ChangeTaskDescriptionResult> {
    return axios
      .post(this.getBasePath() + "/change_task_description", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async connectGoalToProject(input: ConnectGoalToProjectInput): Promise<ConnectGoalToProjectResult> {
    return axios
      .post(this.getBasePath() + "/connect_goal_to_project", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async disconnectGoalFromProject(input: DisconnectGoalFromProjectInput): Promise<DisconnectGoalFromProjectResult> {
    return axios
      .post(this.getBasePath() + "/disconnect_goal_from_project", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async markAllNotificationsAsRead(input: MarkAllNotificationsAsReadInput): Promise<MarkAllNotificationsAsReadResult> {
    return axios
      .post(this.getBasePath() + "/mark_all_notifications_as_read", toSnake(input))
      .then(({ data }) => toCamel(data));
  }

  async markNotificationAsRead(input: MarkNotificationAsReadInput): Promise<MarkNotificationAsReadResult> {
    return axios
      .post(this.getBasePath() + "/mark_notification_as_read", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async removeCompanyTrustedEmailDomain(
    ...
    return axios
      .post(this.getBasePath() + "/remove_company_trusted_email_domain", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async removeProjectContributor(input: RemoveProjectContributorInput): Promise<RemoveProjectContributorResult> {
    return axios
      .post(this.getBasePath() + "/remove_project_contributor", toSnake(input))
      .then(({ data }) => toCamel(data));
  }

  async removeProjectMilestone(input: RemoveProjectMilestoneInput): Promise<RemoveProjectMilestoneResult> {
    return axios
      .post(this.getBasePath() + "/remove_project_milestone", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async updateGroupAppearance(input: UpdateGroupAppearanceInput): Promise<UpdateGroupAppearanceResult> {
    return axios
      .post(this.getBasePath() + "/update_group_appearance", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async updateMilestoneDescription(input: UpdateMilestoneDescriptionInput): Promise<UpdateMilestoneDescriptionResult> {
    return axios
      .post(this.getBasePath() + "/update_milestone_description", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async updateMyNotificationSettings(
    ...
    return axios
      .post(this.getBasePath() + "/update_my_notification_settings", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
  ...
  async updateProjectContributor(input: UpdateProjectContributorInput): Promise<UpdateProjectContributorResult> {
    return axios
      .post(this.getBasePath() + "/update_project_contributor", toSnake(input))
      .then(({ data }) => toCamel(data));
  }

  async updateProjectDescription(input: UpdateProjectDescriptionInput): Promise<UpdateProjectDescriptionResult> {
    return axios
      .post(this.getBasePath() + "/update_project_description", toSnake(input))
      .then(({ data }) => toCamel(data));
  }
...
export async function acknowledgeGoalCheckIn(
  input: AcknowledgeGoalCheckInInput,
): Promise<AcknowledgeGoalCheckInResult> {
...
> {
  return useMutation<AcknowledgeGoalCheckInInput, AcknowledgeGoalCheckInResult>((input) =>
    defaultApiClient.acknowledgeGoalCheckIn(input),
  );
}
...
export function useCreateGoalUpdate(): UseMutationHookResult<CreateGoalUpdateInput, CreateGoalUpdateResult> {
  return useMutation<CreateGoalUpdateInput, CreateGoalUpdateResult>((input) =>
    defaultApiClient.createGoalUpdate(input),
  );
}
...
> {
  return useMutation<SetMilestoneDeadlineInput, SetMilestoneDeadlineResult>((input) =>
    defaultApiClient.setMilestoneDeadline(input),
  );
}
...
export function useUpdateMyAppearance(): UseMutationHookResult<UpdateMyAppearanceInput, UpdateMyAppearanceResult> {
  return useMutation<UpdateMyAppearanceInput, UpdateMyAppearanceResult>((input) =>
    defaultApiClient.updateMyAppearance(input),
  );
}
...
> {
  return useMutation<UpdateMyNotificationSettingsInput, UpdateMyNotificationSettingsResult>((input) =>
    defaultApiClient.updateMyNotificationSettings(input),
  );
}
