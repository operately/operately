...
export const ControlReviewSchema = {
  type: "document",
  name: "control_review",
  ...
  content: [
    {
      type: "richtext",
      name: "description",
      placeholder: "Write your control review here...",
    },
    {
      type: "yes_no_question",
      name: "goals",
    ...
    },
    {
      ...
      question: "Was the control completed on schedule?",
    },
    {
      type: "yes_no_question",
      name: "budget",
      ...
      question: "Was the control completed within budget?",
    },
    {
      type: "yes_no_question",
      name: "roles",
