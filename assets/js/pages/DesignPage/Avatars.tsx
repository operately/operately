  ...
  return (
    <Section>
      ...
      <div className="max-w-2xl mb-8">
        <p className="mt-2">
          Operately uses full-rounded avatar images for user profiles. The avatar image is used to represent a user. If
          the user does not have an avatar image, the user's initials are displayed in a circle. The initials are
