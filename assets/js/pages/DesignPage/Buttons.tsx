...
export function Buttons() {
  return (
    <div className="mt-10">
      <div className="text-content-accent text-xl font-bold"><h2>Buttons</h2></div>

        <div className="max-w-2xl mb-8">
          <p className="mt-2">Operately uses rounded primary and secondary buttons. The primary button is used for the main action on a page, while the secondary button is used for secondary actions or as a subtle call to action. UI copy is written like a sentence, not capitalized.</p>
        </div>
