...
export default function PostAnUpdate({ objectiveID }): JSX.Element {
  ...
  return (
    <div
      className={
        "mt-10 rounded-lg border border-gray-700 overflow-hidden " +
        (active ? "card-shadow" : "")
      }
    >
      <div className="px-4 pt-4 flex justify-between items-center">
        ...
        {active ? (
          <div
            ...
            className="text-dark-2 hover:text-black hover:cursor-pointer"
          >
            <Icon name="cancel" color="dark-2" hoverColor="dark" size="small" />
          </div>
        ) : null}
      </div>
