...
import ProjectContributorRemoving from "@/features/activities/ProjectContributorRemoving";
...
function handler(activity: Activity) {
  return match(activity.action)
    ...
    .with("project_contributor_removing", () => ProjectContributorRemoving)
