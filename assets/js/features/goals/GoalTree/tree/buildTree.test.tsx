...
describe("Tree", () => {
  ...
  describe("filtering active", () => {
    ...
    it("it shows node if it has active children", () => {
      const goals = [
        goalMock("G1", company, john, { isClosed: true }),
        goalMock("G11", marketing, sarah, { parentGoalId: "G11" }),
        goalMock("G111", marketing, john, { parentGoalId: "G111", isClosed: true }),
      ];

      const tree = buildTree(goals, [], defaultOpts);
