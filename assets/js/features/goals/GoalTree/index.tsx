      ...
      >
        <div className="bg-surface-base rounded border border-surface-outline shadow-xl">
          <div className="flex items-center justify-between px-4 pt-4 text-sm">
            ...
            <SecondaryButton size="xs" linkTo={Paths.projectCheckInPath(project.lastCheckIn!.id!)} linkTarget="_blank">
      ...
      >
        <div className="bg-surface-base rounded border border-surface-outline shadow-xl">
          <div className="flex items-center justify-between px-4 pt-4 text-sm">
            ...
            <SecondaryButton size="xs" linkTo={Paths.goalProgressUpdatePath(goal.lastCheckIn!.id!)} linkTarget="_blank">
              Open <Icons.IconArrowUpRight size={14} className="ml-1 inline-block" />
            </SecondaryButton>
          </div>
