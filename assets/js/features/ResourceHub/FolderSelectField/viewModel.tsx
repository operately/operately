...
class NodeLoader {
  ...
  apiFolderToNode(folder: Hub.ResourceHubFolder): ViewModelNode {
    return {
      id: folder!.id!,
      selectable: this.selectionAllowed(folder!),
      name: folder!.name!,
      type: "folder",
      resource: folder!,
  ...
  apiResourceHubToNode(resourceHub: Hub.ResourceHub): ViewModelNode {
    return {
      id: resourceHub!.id!,
      selectable: this.selectionAllowed(resourceHub!),
  ...
  apiFolderToNodeParent(folder: Hub.ResourceHubFolder): ViewModelNode {
    if (folder!.pathToFolder!.length > 0) {
      ...
      return {
        id: parent!.id!,
        selectable: this.selectionAllowed(folder!.pathToFolder!.slice(-1)[0]!),
        name: parent!.name!,
        type: "folder",
        resource: parent!,
      };
      ...
      return {
        ...
        selectable: this.selectionAllowed(folder!.resourceHub!),
  ...
  selectionAllowed(resource: Hub.Resource): boolean {
