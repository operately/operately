...
export type ActivityContent =
  ...
  | ActivityContentProjectStatusUpdateAcknowledged
  | ActivityContentProjectStatusUpdateCommented
  | ActivityContentProjectStatusUpdateEdit
...
export type AddCompanyMemberMutation = {
  __typename?: "RootMutationType";
  addCompanyMember: {
    __typename?: "Person";
    id: string;
...
`;
export type AddCompanyMemberMutationFn = Apollo.MutationFunction<
  AddCompanyMemberMutation,
...
export function useAddCompanyMemberMutation(
  baseOptions?: Apollo.MutationHookOptions<AddCompanyMemberMutation, AddCompanyMemberMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<AddCompanyMemberMutation, AddCompanyMemberMutationVariables>(
    AddCompanyMemberDocument,
    options,
  );
}
...
export type AddCompanyMemberMutationOptions = Apollo.BaseMutationOptions<
  AddCompanyMemberMutation,
  AddCompanyMemberMutationVariables
>;
